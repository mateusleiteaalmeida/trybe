...
const renderSignal = (selectedColor) => {
  if (selectedColor === 'red') return redSignal;
  if (selectedColor === 'yellow') return yellowSignal;
  if (selectedColor === 'green') return greenSignal;
  return null;
};
